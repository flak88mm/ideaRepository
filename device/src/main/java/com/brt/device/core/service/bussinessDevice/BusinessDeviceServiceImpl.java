...
public class BusinessDeviceServiceImpl implements BusinessDeviceService {
    ...
    public boolean deleteBusinessDevice(Long businessDeviceId) {
        ...
        reportDeviceRepository.delete(reportDevice);
